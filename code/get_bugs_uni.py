    ...
    for id in range(i, i + 300):
        try:
            ...
            if bf.find('div', id='error_msg', class_='throw_error'):
                ...
                if imp.split()[1] == 'blocker' or imp.split()[1] == 'critical':
                    ...
                    if bugs_count[3] < 3000 and my_sum(bugs_count) < 10000:
                        ...
                        break
                elif imp.split()[1] == 'trivial' or imp.split()[1] == 'enhancement':
...
fw = open('data_uni_more.json', 'w', encoding='utf-8')
...
fw.close()
'''
fw = open('error_uni_more.txt', 'w', encoding='utf-8')
